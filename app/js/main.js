$(function () {
   ...
   $('.filter-price__input').ionRangeSlider({
      ...
      onStart: function (date) {
         $('.filter-price__from').text(date.from);
         $('.filter-price__to').text(date.to);
      },
